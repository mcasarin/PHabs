...
<html>
    ...
    <body>
    <div class="container">
        <h2 style="text-align:center;">Busca por Conjunto - Entrada</h2>
        <br>
        ...
        <table class="table table-responsive table-striped">
            <thead>
                <tr><th>Conjunto</th><th>AR/Identificador</th><th>Data</th><th>Nome</th><th>Observação</th><th>Discriminação</th><th>Imagem</th></tr>
            </thead>
        ...
        <script src="./buscaEntradaConjunto.js"></script>
    </div>
    </body>
</html>