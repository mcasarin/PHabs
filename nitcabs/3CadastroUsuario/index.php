				...
				$(document).ready( function() {
					$("#cadusuario").validate({
						...
						messages:{
							...
							rg:{
								required: "Digite o RG do usuário, Caso Rg esteja em branco digite \"em branco\", ou digite a placa do Veiculo caso seja TAG.",
				...
				<form method="POST" action="caduser.php" name="cadusuario" id="cadusuario">
					...
					<tr>
						...
						<tr>
							...
							<td> <input type = "text" id = 'campo02' name = "rg"> </td>
						</tr>
						
						<tr>
							<td align = "right" > Digite a Matricula do cartão </td>
							<td> <input type = "text" name = "matricula" id = 'campo03' > </td>
						</tr>
						<tr>
							<td colspan = "8"> 
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
