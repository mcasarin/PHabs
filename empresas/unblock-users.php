...
<form name="formunblock" action="execute_unblock-users.php" method="POST">

	<div class="container">
		<div class="row">
			<div class="col">
				<p>Selecione a empresa para <b>DESBLOQUEAR</b> seus usuários e preencha com o motivo: </p>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<input type="button" class="btn btn-info btn-lg" value=" Desbloquear usuários! " onclick="confirma()">
		</div>
...
<script>
        function confirma() {
				if(confirm("Tem certeza que quer desbloquear os usuário da empresa: " + document.getElementById("empresa").value )){
					formunblock.submit();
				} else {
					return false;
				}
