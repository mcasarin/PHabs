...
$tentarnovamente = "<form action=\"select_date_estac.php\" method=\"get\">
    ...
    echo "<div class=\"table-responsive\">
        ...
        <div class=\"col-sm-4\">$voltar</div>
            ...
            while (strtotime($datatrini) <= strtotime($datatrfim)){
                ...
                $sql  = "insert into $tabelatemp(Nome,Empresa,Matricula,Cartao,ID,Coletor,Data,Hora,Acesso) SELECT Nome,Empresa,Matricula,Cartao,ID,Descricao,Data,Hora,Acesso FROM $datalocal WHERE Hora BETWEEN '$horainicio' and '$horafim' and Descricao = 'ESTACIONAMENTO'";
            ...
            if($sqltempfinalexe->num_rows > 0){
                echo "<table class=\"table table-sm table-striped table-bordered table-hover relatorio\">
