...
if($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if($sqlcreatetempexe){
		...
		echo "<div class=\"row\"><div class=\"col-sm-4\"><form action=\"exportarpdf_v.php\" method=\"post\" target=\"_blank\">
			...
			$sqltempfinal = "select Visitante,Empresa,Matricula,RG,EmpresaVis,Acesso,DataAcesso,HoraAcesso,DColetor,Autorizado,Terminal,Login from $tabelatemp order by DataAcesso,HoraAcesso ASC";
