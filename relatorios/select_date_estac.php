...
<form action="rel_estac.php" method="post">
        <?php
            // Limpando tabela relatório
            $sqllimparel = "truncate table relusuario;";
            $sqllimparelexe = $conn->query($sqllimparel);
		if($formdirect == "reldateestac"){
            // Seleciona estacionamento por data
            ?>
			<div class="alert alert-primary" role="alert">
				Neste relatório serão mostradas todas as tags registradas nas datas selecionadas abaixo.
			</div>
			<?php
		} elseif ($formdirect == "relempresaestac") {
			// Seleciona usuários
